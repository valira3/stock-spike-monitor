...
| `ORB_ATR_STOP_MULT` | `0.0` | If > 0, stop = entry ∓ this × ATR(5m,14) instead of OR opposite ± buffer. Cold-ATR falls back automatically. Live production target: `1.75` (v8.0.0+). |
