...
def scheduler_thread():
    ...
    JOBS = [
        ...
        # 15:58 fires AFTER the ORB EOD cutoff (15:55) and just before
        # the EOD reversal engine's 15:59 exit, giving independent
        # executors room to close their own positions without override.
