...
CURRENT_MAIN_NOTE = (
    "v6.4.0 disable Alarm B,\n"
    "tighten Chandelier trail.\n"
    "Apr 27\u2013May 1 sweep:\n"
    "B-off + 1.5/0.7 multipliers\n"
    "= +$217.93/wk vs baseline\n"
    "(+$831.50 \u2192 +$1,049.43,\n"
    "60 pairs, WR 45%\u219262%).\n"
    "(1) ALARM_B_ENABLED=False\n"
    "by default; check_alarm_b\n"
    "is no longer called from\n"
    "evaluate_sentinel. Noise\n"
    "filter + stateful counter\n"
    "stay in code, zero-cost.\n"
    "(2) Alarm F WIDE_MULT\n"
    "2.0\u21921.5, TIGHT_MULT\n"
    "1.0\u21920.7. Stage 2 arms\n"
    "sooner once B no longer\n"
    "cuts trades early; avg\n"
    "hold 41m\u219262m. (3) EOD\n"
    "harness eod_close@15:49\n"
    "ET ports upstream from\n"
    "replay_v511_full so\n"
    "backtests + prod align.\n"
    "Dashboard: v640_flags\n"
    "block, B cell DISABLED,\n"
    "Local Weather suffix\n"
    "swap to chand 1.5/0.7."
)
