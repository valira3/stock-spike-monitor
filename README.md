...
Both strategies use limit orders and share a per-ticker daily cap.
...
All 1-minute OHLCV bars come from **Yahoo Finance**. PDC (Previous Day Close) is fetched from FMP.

---

## PDC Polarity Anchor

PDC is the single price anchor across every decision in the bot: stock entry gates (price vs PDC), index filters (SPY/QQQ vs PDC), and the Sovereign Regime Shield ejects.
...
The bot maintains a $100k paper portfolio. Every trade is logged, reported to the Telegram group, and persisted.
