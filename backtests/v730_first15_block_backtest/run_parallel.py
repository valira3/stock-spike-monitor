#!/usr/bin/env python3
"""v7.3.0-experimental — First-15-min entry block backtest.

Single variant against v7.0.7 SIP corpus (83 days, 12 prod tickers):
  v730_block15 — V730_FIRST_N_MIN_BLOCK=15, no entries before 09:45 ET.

Baseline already exists at /home/user/workspace/v730_regime_c_skip_backtest/baseline/
so we only run the variant here. Comparison happens in aggregate.py.
"""
...
ISOLATE = Path("/tmp/v730_first15_isolate")
...
VARIANTS = [
    ("block15", {**PROD_BASE, "V730_FIRST_N_MIN_BLOCK": "15"}, "block15"),
]
