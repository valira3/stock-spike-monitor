...
BASELINE_DIR = Path("/home/user/workspace/v730_regime_c_skip_backtest/baseline/per_day")
BLOCK15_DIR  = Path("/home/user/workspace/v730_first15_block_backtest/block15/per_day")
