...
def run_local() -> int:
    ...
    @t("version: BOT_VERSION is 4.0.6")
    def _():
        assert m.BOT_VERSION == "4.0.6", f"got {m.BOT_VERSION}"
    ...
    @t("version: CURRENT_MAIN_NOTE begins with v4.0.6")
    def _():
        assert m.CURRENT_MAIN_NOTE.lstrip().startswith("v4.0.6"), \
