...
def run_local() -> int:
    ...
    @t("version: BOT_VERSION is 4.1.9")
    def _():
        assert m.BOT_VERSION == "4.1.9", f"got {m.BOT_VERSION}"
    ...
    @t("version: CURRENT_MAIN_NOTE begins with v4.1.9")
    def _():
        assert m.CURRENT_MAIN_NOTE.lstrip().startswith("v4.1.9"), \
