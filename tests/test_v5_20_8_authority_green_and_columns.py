...
def test_bot_version_is_5_20_8():
    ...
    assert 'BOT_VERSION = "5.20.9"' in text, "bot_version.py must report 5.20.9"
...
def test_data_pmtx_comp_grid_marker_is_5_20_8():
    js = _read_js()
    assert 'data-pmtx-comp-grid="v5.20.9"' in js, "data-pmtx-comp-grid must be bumped to v5.20.9"
